(function () {
  ...
  var dict = {
    pt: {
      ...
      p1desc: "Transforma a fala do vistoriador em laudo técnico pronto. A IA transcreve, organiza por ambiente e gera o PDF em minutos, com histórico sincronizado e acesso por convite para a equipe.",
      p2kind: "SaaS de vendas",
      p2desc: "Centraliza os leads do WhatsApp em um painel único, mede o nível de interesse de cada contato com IA e dispara os follow-ups automáticos via n8n, sem planilha paralela.",
      p3kind: "SaaS de gestão",
      p3desc: "Agenda do dia, faturamento, taxa de cancelamento e ticket médio em tempo real. O cliente agenda sozinho pelo WhatsApp e o app instala direto no celular da equipe.",
    ...
    en: {
      ...
      p1desc: "Turns the inspector's voice into a finished technical report. AI transcribes it, organizes it room by room and generates the PDF in minutes, with synced history and invite-based access for the team.",
      p2kind: "Sales SaaS",
      p2desc: "Brings every WhatsApp lead into a single dashboard, scores how warm each contact is with AI and fires automatic follow-ups through n8n, with no spreadsheet on the side.",
      p3kind: "Management SaaS",
      p3desc: "Daily schedule, revenue, cancellation rate and average ticket in real time. Clients book by themselves on WhatsApp and the app installs straight onto the team's phone.",
    ...
    es: {
      ...
      p1kind: "App de campo · PWA",
      p1desc: "Convierte la voz del inspector en un informe técnico listo. La IA transcribe, organiza por ambiente y genera el PDF en minutos, con historial sincronizado y acceso por invitación para el equipo.",
      p2kind: "SaaS de ventas",
      p2desc: "Centraliza los leads de WhatsApp en un solo panel, mide el nivel de interés de cada contacto con IA y dispara los seguimientos automáticos con n8n, sin planilla paralela.",
      p3kind: "SaaS de gestión",
      p3desc: "Agenda del día, facturación, tasa de cancelación y ticket medio en tiempo real. El cliente reserva solo por WhatsApp y la app se instala directo en el móvil del equipo.",
