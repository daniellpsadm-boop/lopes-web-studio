(function () {
  ...
  var dict = {
    pt: {
      ...
      p4name: "planejamentos de aula com IA",
      p5name: "gestão para empresas comerciais",
      ...
      p4kind: "App de planejamento pedagógico · IA",
      p4desc: "O Planejamento Semanal é um aplicativo de IA voltado para professores. Ele automatiza a criação de planejamentos pedagógicos semanais: o professor informa turma, período, temas e objetivos das aulas e a IA gera atividades, conteúdos, objetivos e metodologias. A proposta é economizar tempo e facilitar a rotina de planejamento escolar.",
      p4f1: "O professor informa turma, período, temas e objetivos das aulas.",
      p4f2: "A IA gera atividades, conteúdos, objetivos e metodologias.",
      p4f3: "Os planejamentos podem ser revisados e editados pelo professor.",
      p4f4: "Documentos personalizados, com exportação para Word.",
      p5kind: "ERP para o comércio",
      p5desc: "O Girô ERP é um sistema de gestão empresarial voltado para empresas do comércio. Centraliza as principais operações do negócio em uma única plataforma. Em resumo, é um ERP para simplificar a gestão e operação de empresas comerciais.",
      p5f1: "Permite controlar produtos, estoque, vendas e movimentações financeiras.",
      p5f2: "Ajuda o empresário a acompanhar o desempenho e os resultados da operação.",
      p5f3: "A proposta é reduzir controles manuais e organizar os processos da empresa.",
      p5f4: "O sistema oferece uma visão mais integrada das informações do negócio.",
    ...
    en: {
      ...
      p4name: "weekly lesson plans with AI",
      p5name: "management for commercial businesses",
      ...
      p4kind: "AI lesson-planning app",
      p4desc: "Weekly Planning is an AI app for teachers. It automates weekly lesson plans: the teacher enters the class, period, themes and lesson goals, and the AI generates activities, content, objectives and methodologies. The aim is to save time and make school planning easier.",
      p4f1: "The teacher enters class, period, themes and lesson goals.",
      p4f2: "AI generates activities, content, objectives and methodologies.",
      p4f3: "Plans can be reviewed and edited by the teacher.",
      p4f4: "Personalized documents, with Word export.",
      p5kind: "ERP for retail businesses",
      p5desc: "Girô ERP is a business management system built for retail and commercial companies. It centralizes the main operations of the business in a single platform. In short, it is an ERP to simplify the management and operation of commercial businesses.",
      p5f1: "Control products, inventory, sales, and financial movements.",
      p5f2: "Helps the business owner track performance and operational results.",
      p5f3: "The goal is to reduce manual controls and organize company processes.",
      p5f4: "The system offers a more integrated view of business information.",
    ...
    es: {
      ...
      p4name: "planificaciones de clase con IA",
      p5name: "gestión para empresas comerciales",
      p1kind: "App de campo · PWA",
      ...
      p4kind: "App de planificación pedagógica · IA",
      p4desc: "Planificación Semanal es una app de IA para profesores. Automatiza la creación de planificaciones pedagógicas semanales: el profesor indica grupo, período, temas y objetivos de las clases, y la IA genera actividades, contenidos, objetivos y metodologías. La propuesta es ahorrar tiempo y facilitar la rutina de planificación escolar.",
      p4f1: "El profesor indica grupo, período, temas y objetivos de las clases.",
      p4f2: "La IA genera actividades, contenidos, objetivos y metodologías.",
      p4f3: "Las planificaciones pueden revisarse y editarse por el profesor.",
      p4f4: "Documentos personalizados, con exportación a Word.",
      p5kind: "ERP para el comercio",
      p5desc: "Girô ERP es un sistema de gestión empresarial orientado a empresas del comercio. Centraliza las principales operaciones del negocio en una única plataforma. En resumen, es un ERP para simplificar la gestión y operación de empresas comerciales.",
      p5f1: "Permite controlar productos, inventario, ventas y movimientos financieros.",
      p5f2: "Ayuda al empresario a seguir el desempeño y los resultados de la operación.",
      p5f3: "La propuesta es reducir controles manuales y organizar los procesos de la empresa.",
      p5f4: "El sistema ofrece una visión más integrada de la información del negocio.",
